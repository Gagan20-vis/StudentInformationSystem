 ...
 * @author gagan
 */
public class FindByBranch extends javax.swing.JPanel {

    /**
     * Creates new form FindByBranch
     */
    public FindByBranch() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jButton1);
        jButton1.setBounds(560, 260, 160, 40);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setText("Find Student By Branch");
        add(jLabel1);
        jLabel1.setBounds(460, 20, 410, 60);

        jTextField1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        add(jTextField1);
        jTextField1.setBounds(490, 170, 300, 40);

        jList1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jScrollPane1.setViewportView(jList1);

        add(jScrollPane1);
        jScrollPane1.setBounds(300, 340, 680, 210);

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("Branch");
        jLabel2.setToolTipText("");
        add(jLabel2);
        jLabel2.setBounds(370, 170, 130, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<StudBean>list = sd.findByBranch(branch);
